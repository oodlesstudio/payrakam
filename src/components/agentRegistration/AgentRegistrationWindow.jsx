...
const AgentRegistrationWindow = () => {
  ...
  // Change Select
  const [defaultRole, setDefaultRole] = useState("default");

  const [roleValue, setRoleValue] = useState("Bank User Aggregator Role");
  ...
  // Add Role
  const [addRole, setAddRole] = useState("addRoleBtn");
